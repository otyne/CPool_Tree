...
static int get_max_line(int nb)
{
    int line = 4;
    int max_line = 0;
...
static void line_element(int nb, int max_col, int max_line)
{
    int block = 1;
...
static void trunc_element(int nb, int max_col)
{
    int size = nb;
    int ep = nb;
